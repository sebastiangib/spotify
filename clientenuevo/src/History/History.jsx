        ...
        <div className='container'>
            <div className="row">
                <div className="col-12 col-md-6">
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/musicosg-8fe65.appspot.com/o/dp2.jpg?alt=media&token=634a7b32-cdcb-4d9f-a46e-8cad3fe83d55" alt="dp1" className='w-100 img-fluid'/>
                </div>

                <div className="col-12 col-md-3">
                <img src="https://firebasestorage.googleapis.com/v0/b/musicosg-8fe65.appspot.com/o/dp1.jpg?alt=media&token=c7ad6793-c1f9-4257-8825-a2142a8988d4" alt="dp2" className='w-100 img-fluid'/>
                <br /><br />
                    <p>
                    ...
                    <br />
                    El pasado de Doble Porción no es un secreto para nadie. Lo han contado en otras entrevistas y en sus canciones. Hacen parte de Moebiuz y de La Grasa, colectivo compuesto además por Zof Ziro, Granuja y Crudo Means Raw, que pronto presentará su disco.
                    </p>
                </div>
                <div className="col-12 col-md-3">
                    <p>
                    Doble Porción, la agrupación de la que hacía parte desde 2012, fue creada por Marín y Julián Cañas conocido artísticamente como Mañas Ru-Fino. El nombre surgió porque a él y a Métricas Frías les llevaban mucho en la mala: “Eran dos cosas indeseables, entonces de una, Doble Porción”, dijo el integrante en una entrevista para la revista Vice.
                    </p>
                    <img src="https://firebasestorage.googleapis.com/v0/b/musicosg-8fe65.appspot.com/o/dp3.webp?alt=media&token=7cf607de-ee96-4b39-a35c-5061a45a75c9" alt="dp3" className='w-100 img-fluid'/>
                    <br /><br />
                    <p>Poco a poco Métricas Frías y Mañas Ru-Fino se fueron acercando cada vez más y estrechando lazos en la composición de sus canciones y la escritura de letras para las mismas donde contaban su cotidianidad, lo que hacían en común, hablaban de cuando fumaban, salían a la calle a dar vueltas o tenían problemas.
                        <br />
